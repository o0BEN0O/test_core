		       ...
		       bool show_rtnl_err, nl_ext_ack_fn_t errfn)
{
	...
	printf("%s[%d] iov.iov_len[%ld]\n",__func__,__LINE__,iov.iov_len);
	printf("%s[%d] n->nlmsg_len[%d]\n",__func__,__LINE__,n->nlmsg_len);
	printf("%s[%d] n->nlmsg_flags[%d]\n",__func__,__LINE__,n->nlmsg_flags);
	printf("%s[%d] n->nlmsg_type[%d]\n",__func__,__LINE__,n->nlmsg_type);
	printf("%s[%d] n->nlmsg_seq[%d]\n",__func__,__LINE__,n->nlmsg_seq);
	printf("%s[%d] n->nlmsg_pid[%d]\n",__func__,__LINE__,n->nlmsg_pid);
