...
#define WEBS_DEFAULT_HOME		T("index.html") /* Default home page modify by houailing 2013-03-09*/
...
#define WEBS_BUFSIZE			3072	    /*modify by shuwei  old value 960 2013-04-03*/	/* websWrite max output string */
...
#define WEBS_GET_REQUEST		0x100000		/* Get request operation */
#endif
...
typedef struct websRec {
    ...
    char cookiebuf[32]; /* Cookie string */
    int  isDownloadfile;//add by houailing 2012-11-07 1: download, 0:no download
#ifdef JRD_REDIRECT_COMMON_MACRO
    char_t       b_redirect;
    char_t       b_default_unredirect;
#endif
    int  token_flag; //add by huqiao for ee security     1:safe  0:not safe
    char *token;
    char *cer_key;
    char *referer;
    char sock_fd;
...
extern char_t  is_redirect_page;

#define JRD_REDIRECT_PAGE "blog.csdn.net"
#endif
...
extern int       websLocalappApiinit(void);
