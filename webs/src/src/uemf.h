...
pthread_mutex_t webs_done_handle_mutex; /*Added,wenfei, for multi thread issue*/
#endif
/********************************** Unicode ***********************************/
/* 
 ...
 *		#define NO_BALLOC 1
 */
#define NO_BALLOC 1 /*Added by wenfei for remove balloc feature*/
...
extern int 		socketOpenConnection(char *host, int port, 
					socketAccept_t accept, int flags, bool is_client);
...
extern int jrd_get_host_info(char *host_ip, char*host_mask);
